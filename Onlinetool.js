## Version: v3.25.0
## Date: 2021-02-01
## Update Content: 增加京东压岁钱活动互助填写区域；将互助码填写示例放在config.sh.sample文件最后。

## 上面版本号中，如果第2位数字有变化，那么代表增加了新的参数，如果只有第3位数字有变化，仅代表更新了注释，没有增加新的参数，可更新可不更新
## 如需更新，请参考WIKI（https://github.com/EvineDeng/jd-base/wiki）中"如何更新配置文件"部分的操作说明，进行智能比对后修改。

################################## 说明 ##################################
## 以下配置中，带有 export 申明的，均由LXK9301大佬定义，详见：https://github.com/LXK9301/jd_scripts/blob/master/githubAction.md#%E4%B8%8B%E6%96%B9%E6%8F%90%E4%BE%9B%E4%BD%BF%E7%94%A8%E5%88%B0%E7%9A%84-secrets%E5%85%A8%E9%9B%86%E5%90%88
...
Cookie1="pt_key=AAJgF_qlADApMHKIT6S3HRimu_yMqIUYs9o1JHgvHo84uqUTbn2Ts6whDq5mh9olk1ItX4l3CEo;pt_pin=wdXoIaVubHDQiP;"
Cookie2="pt_key=AAJgE4UTADDxrsbOIa3UPw5bRMXkG-O8whmXLPfjGV9H_-13lM9BpvXmPtPf3kmxHHBLPG9sN_I;pt_pin=189873209-311327;"
Cookie3="pt_key=AAJgFCGRADCo_8m87SSwdHP_Y9JnoIcCw3DZkvPXNZY0fxwFvIZFuqbFVTKmJOsjqiyARhj43sg;pt_pin=wdXoIaVubHDQiP;"
Cookie4="pt_key=AAJgE4UrADA3ztEk9bFySrASAlJ2tbWt57zB_XGUh9ZKlkaIY34VuDzt2pPLclbZE07G60ec754;pt_pin=15622052611_p;"
Cookie5="pt_key=AAJgGOW5ADCWsuG8ONDiQw_Qxlea4u9nNOAJj0X7m-aRlciZhdZL_CsHWopvQT7_TxZoYYlymG4;pt_pin=i45728877;"
Cookie6="pt_key=AAJgG3FDADCbfa4mG80ASzUjJVtFUzTOpIvGYZEhptPt2xWR7N0a5k-Aqm1PnDBCWH55x0sjz4w;pt_pin=jd_csJQPXScdqBe;"
...
## 如需使用，请自行解除下一行注释
export JD_USER_AGENT="JD4iPhone/167490 (iPhone; iOS 14.3; Scale/2.00)"
...
export BARK_PUSH="iHujJSBszzPwvmMS8SQ7mJ"
export BARK_SOUND="paymentsuccess"
...
MyFruit5=""
MyFruit6=""
MyFruitA="118ef90ea2be4106ab45f3ff31c2a8f1"
MyFruitB="73b9c21c192948c6b9202303439510d2"
MyFruitC="024a7cad6aa14357966bf03fdc1e7077"

ForOtherFruit1="${MyFruitA}@$MyFruitB}@${MyFruitC}"
...
MyPet5=""
MyPet6=""
MyPetA="MTAxODc2NTEzNTAwMDAwMDAyNzQ1OTEzOQ=="
MyPetB="MTE1NDQ5OTIwMDAwMDAwMzY1OTM3NzM="
MyPetC="MTE1NDAxNzYwMDAwMDAwNDA1NDc1NTc="

ForOtherPet1="${MyPetA}@${MyPetB}@${MyPetC}"
...
MyBean5=""
MyBean6=""
MyBeanA="olmijoxgmjutyw3xraw4bu7jkcdvszaezqfffiq"
MyBeanB="iu237u55hwjiobiy5l2ouqbrmuay6e3tf5t45xq"
MyBeanC="u72q4vdn3zes3icifz3p2wxz67litwp2t7t2zoa"

ForOtherBean1="${MyBeanA}@${MyBeanB}@${MyBeanC}"
...
ForOtherDreamFactory1="${MyDreamFactoryA}@${MyDreamFactoryB}@${MyDreamFactoryC}"
...
ForOtherJdzz1="${MyJdzzA}@${MyJdzzB}@${MyJdzzC}"
...
ForOtherJoy1="${MyJoyA}@${MyJoyB}@${MyJoyC}"
...
MyBookShop5=""
MyBookShop6=""
MyBookShopA="d46e98fa3ee64270ab53cd58f76849a4"
MyBookShopB=""
MyBookShopC=""

ForOtherBookShop1="${MyBookShopA}@${MyBookShopB}@${MyBookShopC}"
ForOtherBookShop2="${MyBookShopA}@${MyBookShopB}@${MyBookShopC}"
ForOtherBookShop3="${MyBookShopA}@${MyBookShopB}@${MyBookShopC}"
ForOtherBookShop4="${MyBookShopA}@${MyBookShopB}@${MyBookShopC}"
ForOtherBookShop5="${MyBookShopA}@${MyBookShopB}@${MyBookShopC}"
ForOtherBookShop6="${MyBookShopA}@${MyBookShopB}@${MyBookShopC}"
...
MyCash5=""
MyCash6=""
MyCashA="eU9YauzhZv9y9GnRzCES1g"
MyCashB="eU9YD7TND49MjxqWrjJZ"
MyCashC=""

ForOtherCash1="${MyCashA}@${MyCashB}@${MyCashc}"
ForOtherCash2="${MyCashA}@${MyCashB}@${MyCashc}"
ForOtherCash3="${MyCashA}@${MyCashB}@${MyCashc}"
ForOtherCash4="${MyCashA}@${MyCashB}@${MyCashc}"
ForOtherCash5="${MyCashA}@${MyCashB}@${MyCashc}"
ForOtherCash6="${MyCashA}@${MyCashB}@${MyCashc}"
...
MySgmh6=""
MySgmhA=""
MySgmhB="T0225KkcRh5K9VeDJR3wk6ULdACjVWmIaW5kRrbA"
MySgmhc="T0205KkcI0ZmnCe9Xm638bZACjVWmIaW5kRrbA"
...
ForOtherNian1="${MyNianA}@${MyNianB}"
ForOtherNian2="${MyNianA}@${MyNianB}"
ForOtherNian3="${MyNianA}@${MyNianB}"
ForOtherNian4="${MyNianA}@${MyNianB}"
ForOtherNian5="${MyNianA}@${MyNianB}"
ForOtherNian6="${MyNianA}@${MyNianB}"
...
MyImmortal5=""
MyImmortal6=""
MyImmortalA="43xIs4YwE5Z7DsWOzDSP6VTEI569kTvBTjMKUu_KLk-JhYcZB9wEQAjz3rp7hG5dJ1Uw"
MyImmortalB="40xIs4YwE5Z7DsWOzDJZ8p1R5nLstQybWAe65EhWxkGcZB9pRws5k2fOF_OP7Pg"

ForOtherImmortal1="${MyImmortalA}@${MyImmortalB}"
ForOtherImmortal2="${MyImmortalA}@${MyImmortalB}"
ForOtherImmortal3="${MyImmortalA}@${MyImmortalB}"
ForOtherImmortal4="${MyImmortalA}@${MyImmortalB}"
ForOtherImmortal5="${MyImmortalA}@${MyImmortalB}"
ForOtherImmortal6="${MyImmortalA}@${MyImmortalB}"
...
MyJdMobileFestival5=""
MyJdMobileFestival6=""
MyJdMobileFestivalA="306db052-b3b2-4927-b9f5-754af242420f"
MyJdMobileFestivalB="59eb030c-1ae9-430d-bafa-ee2a2d354e3a"

ForOtherJdMobileFestival1="${MyJdMobileFestivalA}@${MyJdMobileFestivalB}"
ForOtherJdMobileFestival2="${MyJdMobileFestivalA}@${MyJdMobileFestivalB}"
ForOtherJdMobileFestival3="${MyJdMobileFestivalA}@${MyJdMobileFestivalB}"
ForOtherJdMobileFestival4="${MyJdMobileFestivalA}@${MyJdMobileFestivalB}"
ForOtherJdMobileFestival5="${MyJdMobileFestivalA}@${MyJdMobileFestivalB}"
ForOtherJdMobileFestival6="${MyJdMobileFestivalA}@${MyJdMobileFestivalB}"
...
if [ $(date "+%H") -ge 11 ] && [ $(date "+%H") -lt 13 ]; then
...
export JOY_TEAM_LEVEL="2&2&2&2&2&2"
...
################################## 你所处的经纬度（选填） ##################################
## 神仙书院（jd_immortal.js）这个脚本所需的，你所处的经纬度，用于做逛身边好店任务，如：export JD_IMMORTAL_LATLON='{"lat":33.1, "lng":118.1}'
## 可以使用手机自带的指南针获取所在经纬度，越精确越好，最长可保留小数点后9位数字
export JD_IMMORTAL_LATLON='{"lat":33.1, "lng":118.1}'


################################## 京东炸年兽小程序自定义UA变量（选填） ##################################
## 京东炸年兽（（jd_nian_wechat.js））这个脚本所需的，需要使用抓包工具自行抓包，建议填写，防止黑号。
## 示例：export JD_WECHAT_USER_AGENT="Mozilla/5.0 (iPhone; CPU iPhone OS 14_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15A148 MicroMessenger/7.0.20(0x17001320) NetType/WIFI Language/zh_CN"
export JD_WECHAT_USER_AGENT="Mozilla/5.0 (iPhone; CPU iPhone OS 14_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15A148 MicroMessenger/7.0.20(0x17001320) NetType/WIFI Language/zh_CN"
